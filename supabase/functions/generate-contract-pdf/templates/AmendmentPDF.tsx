// ============================================================================
// Port serveur-side de src/lib/pdf/AmendmentPDF.tsx.
...
const s = StyleSheet.create({
  ...
  title: { fontSize: 14, fontWeight: 700, textAlign: "center", marginBottom: 8, color: c.accent },
  subtitle: { fontSize: 9, textAlign: "center", color: c.muted, marginBottom: 20 },
  articleTitle: { fontSize: 9, fontWeight: 700, color: c.accent, marginBottom: 4, marginTop: 14 },
  ...
  changeLabel: { fontSize: 7, fontWeight: 700, textTransform: "uppercase", letterSpacing: 0.8, marginBottom: 4 },
  ...
  highlightText: { fontSize: 8.5, fontWeight: 700, color: c.primary },
  ...
  newBadge: { fontSize: 7, color: c.green, fontWeight: 700 },
  signatureRow: { flexDirection: "row", gap: 40, marginTop: 16 },
  signatureBox: { flex: 1 },
  signatureLabel: { fontSize: 8, fontWeight: 700, color: c.muted, marginBottom: 4 },
  ...
  return (
    <Document>
      <Page size="A4" style={s.page}>
        ...
        <View style={s.table}>
          <View style={s.thead}>
            <Text style={[s.th, s.colZone]}>Réf</Text>
            <Text style={[s.th, s.colRef]}>QR code</Text>
            <Text style={[s.th, s.colStatus]}></Text>
          </View>
          {panelsAfter.map((p, i) => (
            <View key={i} style={addedIds.has(p.panel_id) ? s.trowNew : s.trow}>
              <Text style={[s.td, s.colZone]}>{p.reference}</Text>
              <Text style={[s.td, s.colRef]}>{p.qr_code}</Text>
        ...
        <View style={s.highlightBox}>
          <Text style={s.highlightText}>
            Total : {panelsAfter.length} support{panelsAfter.length !== 1 ? "s" : ""}
          </Text>
        </View>
